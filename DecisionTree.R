...
grid <- expand.grid(C = c(0.001,0.01,0.1,0.25,0.5,0.75,0.99)) # confidence parameter
...
model <- train(ID~., data=originalData, trControl=train_control, method="J48",metric="ROC",   tuneGrid = grid)
model
