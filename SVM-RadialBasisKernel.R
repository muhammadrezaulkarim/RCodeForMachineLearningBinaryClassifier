...
grid <- expand.grid(C = c(0.001,0.01,0.1,0.25,0.5,0.75,1,10,50,100))
...
model <- train(ID~., data=originalData, trControl=train_control, method="svmRadialCost",metric="ROC", tuneGrid =grid)
model
